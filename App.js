...
const HISTORY = [
  ...
  },
  {
    id: 2,
    action: "Edge Updated",
    detail: "Acacia Hall → Admin Office",
    user: "admin",
    time: "18 mins ago",
    type: "edit",
    date: "2024-06-10",
  ...
  },
  {
    ...
    detail: "Foundation Day – Main Plaza",
    user: "mcruz",
    time: "5 hrs ago",
    type: "event",
    date: "2024-06-09",
  },
  {
    id: 6,
    action: "Node Updated",
    detail: "Guidance Office – Main Bldg",
    user: "admin",
    time: "Yesterday",
    type: "edit",
    date: "2024-06-09",
  ...
  },
  {
    id: 8,
    action: "Node Added",
    detail: "Comfort Room – Gym Building",
    user: "mcruz",
    time: "2 days ago",
    type: "add",
    date: "2024-06-07",
...
const MENU_ITEMS = [
  ...
  { id: "map", label: "Map Overview" },
  { id: "nodes", label: "Nodes" },
  { id: "edges", label: "Edges" },
  { id: "events", label: "Events" },
  { id: "analytics", label: "Path Analytics" },
  { id: "history", label: "History" },
  { id: "backtoapp", label: "Back to App" },
  ...
  return (
    <View style={[styles.historyItem, isLast && { borderBottomWidth: 0 }]}>
      <View style={[styles.historyBadge, { backgroundColor: t.bg }]}>
        <Text style={[styles.historyBadgeText, { color: t.color }]}>
          {t.label}
        </Text>
      </View>
...
const ColumnChart = () => {
  ...
  return (
    <View style={{ height: chartH + 40, paddingTop: 8 }}>
      ...
      <View
        style={{ flexDirection: "row", gap: 8, paddingLeft: 16, marginTop: 6 }}
      >
        {CHART_DATA.map((d, i) => (
...
const PathsModal = ({ visible, onClose }) => {
  ...
  const filtered = useMemo(() => {
    ...
    if (selectedMonth.month !== null) {
      data = data.filter(
        (d) => d.month === selectedMonth.month && d.year === selectedMonth.year,
      );
    }
            ...
            <View style={styles.searchBar}>
              ...
              {search.length > 0 && (
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={{ fontSize: 16, color: C.gray, lineHeight: 18 }}>
                    ×
                  </Text>
                </TouchableOpacity>
              )}
            ...
            renderItem={({ item, index }) => {
              ...
              return (
                <View style={styles.pathItem}>
                  <View
                    style={[
                      styles.pathRankBadge,
                      { backgroundColor: rb, borderColor: rc + "40" },
                    ]}
                  >
                    <Text style={[styles.pathRankNum, { color: rc }]}>
                      #{rank}
                    </Text>
                  </View>
...
function AnimatedCounter({ anim, style, color }) {
  ...
  return <Text style={[style, { color }]}>{display.toLocaleString()}</Text>;
}
...
export default function App() {
  ...
  const nodeCount = statAnims[0].interpolate({
    inputRange: [0, 1],
    outputRange: [0, STATS.nodes],
  });
  const edgeCount = statAnims[1].interpolate({
    inputRange: [0, 1],
    outputRange: [0, STATS.edges],
  });
  const userCount = statAnims[2].interpolate({
    inputRange: [0, 1],
    outputRange: [0, STATS.users],
  });
  ...
  return (
    <View style={styles.root}>
      ...
      >
        <Animated.View
          style={{ opacity: contentOp, transform: [{ translateY: contentY }] }}
        >
          {/* ── WELCOME STRIP ─────────────────────────────────────────────── */}
          ...
          <View style={styles.statsGrid}>
            ...
            <View style={[styles.statCard, { borderTopColor: C.blue }]}>
              <View
                style={[styles.statIconWrap, { backgroundColor: C.blueFaint }]}
              >
            ...
            <View style={[styles.statCard, { borderTopColor: C.green }]}>
              <View
                style={[styles.statIconWrap, { backgroundColor: C.greenFaint }]}
              >
          ...
          <View style={styles.sectionCard}>
            ...
            <View style={styles.sectionSubRow}>
              <Text style={styles.sectionSubtitle}>
                Commonly used routes by app users
              </Text>
          ...
          <View style={[styles.sectionCard, { marginBottom: 24 }]}>
            ...
            <Text style={styles.sectionSubtitle}>
              Recent modifications to map data
            </Text>
            ...
            >
              ...
              <View style={styles.menuAdminInfo}>
                ...
                <View style={styles.menuTextContainer}>
                  ...
                  <Text
                    style={styles.menuAdminRole}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
                    Super Admin · Osmeña Colleges
                  </Text>
                </View>
              </View>
